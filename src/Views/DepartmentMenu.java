...
public class DepartmentMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(644, 369));
        ...
        jLabel1.setText("DEPARTMENT MAINTENANCE SCREEN");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        dispose();
        AddDeptMenu obj = new AddDeptMenu();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        dispose();
        try {
            DelDeptMenu obj = new DelDeptMenu();
            obj.setVisible(true);
            obj.setLocation(300,50);
            //obj.setLocationRelativeTo(null);
        } catch (Exception e) {
